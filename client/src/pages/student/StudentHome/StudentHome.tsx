...
import { Book, CalendarCheck, LayoutList, User } from "lucide-react";
			...
			<div className="flex h-full bg-white">
				...
				<Sidebar>
					<div className="pt-1">
						...
						<SidebarItem name="Ispitni Rokovi" active={session.metadata.studentTab === 1} to={1} changeData={handleDataChange} Icon={CalendarCheck} />
						<SidebarItem name="Ispiti" active={session.metadata.studentTab === 2} to={2} changeData={handleDataChange} Icon={LayoutList} />
						<SidebarItem name="Predmeti" active={session.metadata.studentTab === 3} to={3} changeData={handleDataChange} Icon={Book} />
					</div>
				</Sidebar>
			</div>
		</div>
